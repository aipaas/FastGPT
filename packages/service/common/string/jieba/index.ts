...
export async function jiebaSplitWithCustomDict({
  ...
  if (!cachedJieba) {
    try {
      ...
      console.error('创建自定义 jieba 实例失败，使用默认分词:', {
