...
describe('/api/core/evaluation/metric/delete', () => {
  ...
  it('should reject when metricId parameter is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricIdRequired);
  ...
  it('should reject when metric is not found', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricNotFound);
  ...
  it('should reject when trying to delete builtin metric', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricBuiltinCannotDelete);
