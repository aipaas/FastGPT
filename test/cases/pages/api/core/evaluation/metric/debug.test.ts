...
describe('/api/core/evaluation/metric/debug', () => {
  ...
  it('should reject when userInput is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.evalCaseUserInputRequired);
  ...
  it('should reject when actualOutput is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.evalCaseActualOutputRequired);
  ...
  it('should reject when expectedOutput is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.evalCaseExpectedOutputRequired);
  ...
  it('should reject when LLM model name is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.llmModelNameRequired);
  ...
  it('should handle evaluator network error correctly', async () => {
    ...
    const mockEvaluate = vi.fn().mockRejectedValue(new Error(EvaluationErrEnum.evaluatorNetworkError));
    vi.mocked(DitingEvaluator).mockImplementation(() => ({
      evaluate: mockEvaluate
    }) as any);
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.evaluatorNetworkError);
  ...
  it('should handle evaluator timeout error correctly', async () => {
    ...
    const mockEvaluate = vi.fn().mockRejectedValue(new Error(EvaluationErrEnum.evaluatorRequestTimeout));
    vi.mocked(DitingEvaluator).mockImplementation(() => ({
      evaluate: mockEvaluate
    }) as any);
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.evaluatorRequestTimeout);
  ...
  it('should handle non-evaluator error with debug failed error code', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.debugEvaluationFailed);
  ...
  it('should reject when llmConfig is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.llmConfigRequired);
    expect(authUserPer).toHaveBeenCalled();
  });
  ...
  it('should reject when userInput exceeds maximum length', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.evalCaseUserInputTooLong);
    expect(authUserPer).toHaveBeenCalled();
  });
  ...
  it('should reject when prompt exceeds maximum length', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricPromptTooLong);
    expect(authUserPer).toHaveBeenCalled();
  });
  ...
  it('should reject when metric name exceeds maximum length', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricNameTooLong);
    expect(authUserPer).toHaveBeenCalled();
  });
  ...
  it('should reject when metric type is missing', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricTypeRequired);
    expect(authUserPer).toHaveBeenCalled();
  });
  ...
  it('should reject when invalid metric type is provided', async () => {
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.metricTypeInvalid);
    expect(authUserPer).toHaveBeenCalled();
  });

  it('should reject when invalid base URL is provided', async () => {
    vi.mocked(authUserPer).mockResolvedValue({
      userId: mockUserId,
      teamId: mockTeamId,
      tmbId: mockTmbId,
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.llmBaseUrlInvalid);
    expect(authUserPer).toHaveBeenCalled();
  });

  it('should reject when invalid timeout is provided', async () => {
    vi.mocked(authUserPer).mockResolvedValue({
      userId: mockUserId,
      teamId: mockTeamId,
      tmbId: mockTmbId,
    ...
    await expect(handler(req as any, {} as any)).rejects.toBe(EvaluationErrEnum.llmTimeoutInvalid);
    expect(authUserPer).toHaveBeenCalled();
  });
});
