...
const SearchParamsTip = ({
  ...
  const onlyDatabase = useMemo(() => hasDatabaseKnowledge && !hasOtherKnowledge, [hasDatabaseKnowledge, hasOtherKnowledge]);
      ...
      <Table fontSize={'xs'} overflow={'overlay'}>
        ...
        <Tbody>
          <Tr color={'myGray.800'}>
            ...
            {
              hasDatabaseKnowledge && <Td pt={0} pb={2}>
                {limit}
              </Td>
            }
          </Tr>
