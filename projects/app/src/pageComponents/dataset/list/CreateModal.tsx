        ...
        </Box>
        {
          ...
          >
            ...
            >
              ...
              {
                vectorModelShowConfig?.tip ? <QuestionTip label={t(vectorModelShowConfig.tip)} /> : <QuestionTip label={t('common:core.dataset.embedding model tip')} />
              }
            </HStack>
            <Box w={['100%', '300px']}>
              <AIModelSelector
...

        {
          ...
          >
            ...
            >
              ...
              {
                agentModelShowConfig?.tip ? <QuestionTip label={t(agentModelShowConfig.tip)} /> : <QuestionTip label={t('dataset:file_model_function_tip')} />
              }
            </HStack>
            <Box w={['100%', '300px']}>
              <AIModelSelector
