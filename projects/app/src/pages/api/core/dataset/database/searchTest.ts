import { DatabaseSearchTestResponse } from "@/global/core/dataset/api";
...
import { generateAndExecuteSQL, SearchDatabaseData } from "@fastgpt/service/core/dataset/search/controller";
...
async function handler(
    ...
    if (schema){
        ...
        if (generateSqlResult) {addLog.info('Dataset Search - SQL Generation Success', {
            datasetId,
